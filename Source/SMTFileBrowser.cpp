...
//==============================================================================
void SMTFileBrowser::addListener (FileBrowserListener* const newListener)
{
    listeners.add (newListener);
}

void SMTFileBrowser::removeListener (FileBrowserListener* const listener)
{
    listeners.remove (listener);
}

//==============================================================================
bool SMTFileBrowser::isSaveMode() const noexcept
{
    return (flags & saveMode) != 0;
}

int SMTFileBrowser::getNumSelectedFiles() const noexcept
{
...
File SMTFileBrowser::getSelectedFile (int index) const noexcept
{
...
bool SMTFileBrowser::currentFileIsValid() const
{
...
File SMTFileBrowser::getHighlightedFile() const noexcept
{
    return fileListComponent->getSelectedFile (0);
}

void SMTFileBrowser::deselectAllFiles()
{
    fileListComponent->deselectAllFiles();
}

//==============================================================================
bool SMTFileBrowser::isFileSuitable (const File& file) const
{
    return (flags & canSelectFiles) != 0
    && (fileFilter == nullptr || fileFilter->isFileSuitable (file));
}

bool SMTFileBrowser::isDirectorySuitable (const File&) const
{
    return true;
}

bool SMTFileBrowser::isFileOrDirSuitable (const File& f) const
{
    if (f.isDirectory())
...
//==============================================================================
const File& SMTFileBrowser::getRoot() const
{
    return currentRoot;
}

void SMTFileBrowser::setRoot (const File& newRootDirectory)
{
...
void SMTFileBrowser::setFileName (const String& newName)
{
...
void SMTFileBrowser::resetRecentPaths()
{
...
void SMTFileBrowser::goUp()
{
    setRoot (getRoot().getParentDirectory());
}

void SMTFileBrowser::refresh()
{
    fileList->refresh();
}

void SMTFileBrowser::setFileFilter (const FileFilter* const newFileFilter)
{
...
String SMTFileBrowser::getActionVerb() const
{
...
void SMTFileBrowser::setFilenameBoxLabel (const String& name)
{
    fileLabel.setText (name, dontSendNotification);
}

FilePreviewComponent* SMTFileBrowser::getPreviewComponent() const noexcept
{
    return previewComp;
}

DirectoryContentsDisplayComponent* SMTFileBrowser::getDisplayComponent() const noexcept
{
    return fileListComponent.get();
}

//==============================================================================
void SMTFileBrowser::resized()
{
...
//==============================================================================
void SMTFileBrowser::lookAndFeelChanged()
{
...
//==============================================================================
void SMTFileBrowser::sendListenerChangeMessage()
{
    Component::BailOutChecker checker (this);
...
void SMTFileBrowser::selectionChanged()
{
...
void SMTFileBrowser::fileClicked (const File& f, const MouseEvent& e)
{
    Component::BailOutChecker checker (this);
    listeners.callChecked (checker, [&] (FileBrowserListener& l) { l.fileClicked (f, e); });
}

void SMTFileBrowser::fileDoubleClicked (const File& f)
{
    if (f.isDirectory())
    {
        setRoot (f);
...
void SMTFileBrowser::browserRootChanged (const File&) {}

bool SMTFileBrowser::keyPressed (const KeyPress& key)
{
    // Load file to sound 1
...
//==============================================================================
void SMTFileBrowser::changeFilename()
{
...
//==============================================================================
void SMTFileBrowser::updateSelectedPath()
{
...
void SMTFileBrowser::getDefaultRoots (StringArray& rootNames, StringArray& rootPaths)
{
#if JUCE_WINDOWS
    Array<File> roots;
...
void SMTFileBrowser::getRoots (StringArray& rootNames, StringArray& rootPaths)
{
    getDefaultRoots (rootNames, rootPaths);
}

void SMTFileBrowser::timerCallback()
{
