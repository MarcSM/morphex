...
//    typedef std::array<Note*, MorphLocation::NUM_MORPH_LOCATIONS> MorphNotes;
    struct MorphNotes
    {
        ...
        //        std::vector<Note*> _morph_notes = std::vector<Note*> (MorphLocation::NUM_MORPH_LOCATIONS);
//        std::vector <std::reference_wrapper <Note*> > _morph_notes = std::vector< std::reference_wrapper<Note*> > (MorphLocation::NUM_MORPH_LOCATIONS);
//        std::vector <std::reference_wrapper <Note> > _morph_notes = std::vector< std::reference_wrapper<Note> > (MorphLocation::NUM_MORPH_LOCATIONS);
//        Note* _morph_notes [MorphLocation::NUM_MORPH_LOCATIONS];
//        std::reference_wrapper<Note*> _morph_notes [MorphLocation::NUM_MORPH_LOCATIONS];

        MorphNotes()
        {
//            for (int i = 0; i < i_notes_to_load; i++)
//            {
//                this->_morph_notes[i] = loaded_notes[i];
//            }
        }

//        std::array<Note*, MorphLocation::NUM_MORPH_LOCATIONS> _morph_notes;
//        std::array<Note*, MorphLocation::NUM_MORPH_LOCATIONS> _morph_notes;

//        Note& operator [] (Note* new_note);
//        Note operator [] (MorphLocation i);
//        Note operator [] (int i);
        
//        std::vector<Note*> operator [] ()
//        {
//            return this->_morph_notes;
//        }
...
//        std::reference_wrapper<Note> operator [] (int i)
//        {
//            std::reference_wrapper<Note> test = *new Note(0);
//            return test;
//        }
...
//        }
//
//        std::reference_wrapper<Note> _aux {*new Note(0)};
//
//        std::reference_wrapper<Note> operator [] (int i)
//        {
//            return this->_aux;
//        }
        ...
        //        {
        //            return this->_morph_notes[0].get();
        ////            return *this->_morph_notes[0];
        ////            return *this->_morph_notes[0];
        //            //            return *this;
        //        }
...
//        MorphNotes& operator = (MorphNotes& right)
//        MorphNotes& operator = (MorphNotes& new_note)
//        Note& operator = (Note& new_note)
//        Note* operator = (Note& new_note)
...
//            return note;
////            return *this;
////            return _morph_notes[0];
////            return new_note;
//        }
        
//        void operator[](int i, Note* new_note) { this->_morph_notes[i] = new_note; }
//        Note* operator[](int i) { return this->_morph_notes[i]; }
