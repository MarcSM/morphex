        ...
        if (this->test_tone.active)
        {
            if (this->test_tone.angleDelta != 0.0)
            {
                if (this->test_tone.tailOff > 0.0)
                {
                    while (--numSamples >= 0)
                    {
                        auto currentSample = (float) (std::sin (this->test_tone.currentAngle) * level * this->test_tone.tailOff);
                ...
                else
                {
                    while (--numSamples >= 0)
                    {
                        auto currentSample = (float) (std::sin (this->test_tone.currentAngle) * level);
