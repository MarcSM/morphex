...
//                    };
                    ...
                    this->max_frames = (int) std::max
                    ({
                        (int) this->model->values.harmonic.freqs.size(),
                        (int) this->model->values.harmonic.mags.size(),
                        (int) this->model->values.harmonic.phases.size(),
                        (int) this->model->values.sinusoidal.freqs.size(),
                        (int) this->model->values.sinusoidal.mags.size(),
