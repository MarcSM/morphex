...
public:
    ...
    struct JUCE_API  LookAndFeelMethods
    {
        ...
        virtual void layoutSMTFileBrowser (SMTFileBrowser& browserComp,
    ...
    /** A set of colour IDs to use to change the colour of various aspects of the SMTFileBrowser.
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SMTFileBrowser)
};
